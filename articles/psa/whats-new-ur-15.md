...
description: En este artículo se proporciona información sobre las novedades y los cambios en la versión 15 de Project Service Automation, V3.
author: ruhercul
...
En este artículo se enumeran las funciones y correcciones que son nuevas o modificadas para PSA V3, Update Release 15. Esta versión tiene un número de compilación de V3.10.5.28 y está disponible con carácter general a través de una actualización automática en enero de 2020.
