...
description: En este artículo se proporciona información sobre las novedades y los cambios en la versión 14 de Project Service Automation V3.
author: ruhercul
...
En este artículo se enumeran las funciones y correcciones que son nuevas o modificadas para PSA V3, Update Release 14. Esta versión tiene un número de compilación de V3.10.4.21 y está disponible en la siguiente programación:
