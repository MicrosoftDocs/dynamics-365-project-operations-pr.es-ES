...
description: En este artículo se explica cómo recuperar devoluciones en las transacciones para el impuesto sobre el valor añadido (IVA).
author: saraschi2
ms.date: 02/26/2018
ms.topic: article
ms.prod: ''
