...
description: Este artículo explica cómo crear términos de pago al cobro (PWP) para que pueda liberar pagos parciales a proveedores, en función de los pagos de los clientes.
author: RadhikaRS
ms.date: 03/30/2020
ms.topic: article
ms.prod: ''
