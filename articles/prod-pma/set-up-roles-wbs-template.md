...
description: Este artículo proporciona información sobre cómo configurar la información de roles en las plantillas de la estructura de descomposición del trabajo.
author: Yowelle
ms.date: 09/01/2020
ms.topic: article
ms.prod: ''
