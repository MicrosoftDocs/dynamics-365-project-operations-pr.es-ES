...
description: Este artículo proporciona información sobre las actualizaciones de calidad disponibles en la versión de junio de 2021 de la implementación de Project Operations Lite.
author: sigitac
ms.date: 06/10/2021
ms.topic: article
ms.prod: ''
