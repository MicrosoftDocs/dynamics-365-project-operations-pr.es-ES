...
description: Este artículo proporciona información y ejemplos que lo ayudarán a usar los registros de programación de proyectos para rastrear errores relacionados con el servicio de programación de proyectos y las API de programación de proyectos.
author: ruhercul
ms.date: 11/30/2021
ms.topic: article
