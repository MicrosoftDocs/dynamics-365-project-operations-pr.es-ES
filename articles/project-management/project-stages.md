...
description: Este artículo proporciona información sobre las etapas del proyecto que están disponibles en Microsoft Dynamics Project Operations.
author: ruhercul
ms.date: 09/18/2020
ms.topic: article
ms.prod: ''
...
Cuando gana una oferta asociada a un proyecto, y el proyecto se mueve a la fase **Contrato**, la fase del proyecto se actualiza a **Planificar**. Cuando el proyecto se encuentra en la fase **Plan**, la pestaña **Ventas** en la página **Entidad del proyecto** muestra detalles del contrato.
