...
description: Este artículo proporciona información sobre cómo trabajar con facturas de proyecto proforma.
author: rumant
ms.date: 04/05/2021
ms.topic: article
...
Los siguientes campos están disponibles en el detalle de una línea de factura que está respaldado por un real de ventas no facturadas:
...
### <a name="create-new-invoice-line-details"></a>Crear detalles de línea de factura

En las líneas de factura de tiempo y material, puede crear nuevos detalles de línea de factura. Estos detalles de la línea de factura no están respaldados por un archivo. En la línea de factura de una línea de factura de tiempo y material, puede seleccionar **Nuevo** para crear un nuevo detalle de línea de factura para las clases de transacciones que se incluyen en la línea de contrato.
...
## <a name="product-based-invoice-lines"></a>Líneas de factura basadas en producto
