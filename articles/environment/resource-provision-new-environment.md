...
2. En la lista **Característica de vista previa**, seleccione **Project Operations** y **Función de vista previa habilitada** para habilitar Project Operations.
...
| **Entidad de integración de operaciones de proyecto para estimaciones de tiempo (asignaciones de recursos\_msdyn)** | No | No | N/D | No | N/D |
...
5. Continúe con la ejecución del mapa después de que se complete la actualización.

![Actualizar Mapa](./media/20RefreshMapping.png)

Antes de habilitar el siguiente mapa, verifique que el mapa de la tabla esté en un estado de **Ejecución**. La ejecución de mapas con una mayor cantidad de requisitos previos puede llevar algún tiempo.
