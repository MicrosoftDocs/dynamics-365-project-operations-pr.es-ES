...
description: Este artículo explica cómo se utiliza el concepto de orígenes de transacciones para vincular los datos reales con los registros de origen originales, como la entrada de horas, la entrada de gastos o los registros de uso de materiales.
author: rumant
ms.date: 03/25/2021
ms.topic: article
ms.prod: ''
