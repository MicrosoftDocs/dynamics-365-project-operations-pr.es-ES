...
description: En este artículo se proporciona información sobre cómo trabajar con el modelo de datos.
author: ruhercul
ms.custom:
...
Dynamics 365 Project Service Automation amplía otras entidades de la aplicación e introduce sus propias entidades en el modelo de datos de Common Data Service. En este artículo se describen algunas de las entidades que encontrará en los escenarios de informes típicos de PSA.
