...
description: Este artículo proporciona información sobre las actualizaciones de calidad disponibles en la versión de marzo de 2021 de la implementación de Project Operations Lite.
author: sigitac
ms.date: 03/03/2021
ms.topic: article
ms.prod: ''
