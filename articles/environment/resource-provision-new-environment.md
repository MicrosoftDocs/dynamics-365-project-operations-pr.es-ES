...
description: Este artículo proporciona información sobre cómo aprovisionar un nuevo entorno de Project Operations.
author: sigitac
ms.date: 09/13/2021
ms.topic: article
ms.prod: ''
...
Este artículo proporciona información sobre cómo aprovisionar un nuevo entorno de Dynamics 365 Project Operations para escenarios basados en recursos/sin existencias.
...
1. Abra una nueva implementación de Dynamics 365 Finance [entorno de demostración](/dynamics365/fin-ops-core/dev-itpro/deployment/deploy-demo-environment) o [entorno aislado/entorno de producción](/dynamics365/fin-ops-core/dev-itpro/deployment/deployenvironment-newinfrastructure). 
...
5. Seleccione ambas soluciones,**Asignación de tablas de doble escritura de Dynamics 365 Finance** y **Asignación de tablas de doble escritura de Dynamics 365 Project Operations** y luego seleccione **Aplicar**.
